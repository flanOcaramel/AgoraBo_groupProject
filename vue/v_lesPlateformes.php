    ...
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <form action="index.php?uc=gererPlateformes" method="post">
                <td>Nouveau</td>
                <td>
                    <input type="text" id="txtLibPlateforme" name="txtLibPlateforme" size="24" required minlength="2"  maxlength="24"  placeholder="Libellé" title="De 2 à 24 caractères"  />
                </td>
                <td> 
              ...
              <tr>
                ...
                <td><?php 
                    ...
                    <?php
                        ...
                        ?><input type="text" id="txtLibPlateforme" name="txtLibPlateforme" size="24" required minlength="2"  maxlength="24"   value="<?php echo $plateforme->libelle; ?>" />     
                        </td>
                        <td>		 
